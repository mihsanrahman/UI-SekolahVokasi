              ...
              children: [
                Row(
                  children: [
                    ...
                    const Spacer(),
                    Text('065120147', style: vkTextCardBold),
          ...
          Padding(
            ...
            child: Row(
              children: [
                ...
                const Spacer(),
                Text('Muhammad Ihsan Rahman', style: vkTextLightGrey),
              ],
            ),
          ),
          ...
          Padding(
            ...
            child: Row(
              children: [
                ...
                const Spacer(),
                Text('Ihsan', style: vkTextLightGrey),
              ],
            ),
          ),
          const Divider(color: Color(0xffee8301)),
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Jl. KH Sholeh Iskandar, No 21, Kelurahan Cibadak, Kecamatan Tanah Sareal, Bogor, Jawa Barat, Indonesia, 16115',
